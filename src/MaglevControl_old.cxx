...
MaglevControl::maglevController ( Reading curr_force)
{
        ...
        // Calculate rotation matrix
        rotation_matrix[0][0] = (1.0-0.5*current_position[4]*current_position[4])*(1.0-0.5*current_position[5]*current_position[5]);
        rotation_matrix[0][1] = (current_position[3])*(current_position[4])*(1.0-0.5*current_position[5]*current_position[5]) - (1.0-0.5*current_position[3]*current_position[3])*(current_position[5]);
        rotation_matrix[0][2] = (1.0-0.5*current_position[3]*current_position[3])*(current_position[4])*(1.0-0.5*current_position[5]*current_position[5]) + (current_position[3])*(current_position[5]);
        rotation_matrix[1][0] = (1.0-0.5*current_position[4]*current_position[4])*(current_position[5]);
        rotation_matrix[1][1] = (current_position[3])*(current_position[4])*(current_position[5]) + (1.0-0.5*current_position[3]*current_position[3])*(1.0-0.5*current_position[5]*current_position[5]);
        rotation_matrix[1][2] = (1.0-0.5*current_position[3]*current_position[3])*(current_position[4])*(current_position[5]) - (current_position[3])*(1.0-0.5*current_position[5]*current_position[5]);
        rotation_matrix[2][0] = -(current_position[4]);
        rotation_matrix[2][1] = (current_position[3])*(1.0-0.5*current_position[4]*current_position[4]);
        rotation_matrix[2][2] = (1.0-0.5*current_position[3]*current_position[3])*(1.0-0.5*current_position[4]*current_position[4]);
	...
	for (int dirIdx=FORCE_START_INDEX; dirIdx < FORCE_STOP_INDEX; dirIdx++)
	{
	        ...
	        desired_maglev = 0.0;
                ...
                //measured_maglev = rotation_matrix[dirIdx][0] * curr_force
                ...
                if (force_control_directions[dirIdx])
                {
                        ...
                        //pid_output[dirIdx] = -(K_P * proportional + K_I * integral[dirIdx] + desired_maglev[dirIdx]) - K_V * velocity[dirIdx];
                        pid_output[dirIdx] = -(K_P * proportional + K_I * integral[dirIdx] + desired_maglev) - K_V * velocity[dirIdx];
                }
                else
                {
        ...
        pid_output[2] = pid_output[2] + mass*gravity;
        pid_output[3] = pid_output[3] - mass*gravity*r_y;
        pid_output[4] = pid_output[4] + mass*gravity*r_x;
